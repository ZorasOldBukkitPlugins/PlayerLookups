package com.lagopusempire.playerlookups.zorascommandsystem;
...
public class CommandSystem<T>
{
     ...
     *
     * @param cmdString The format for the command to be referenced with by the
     * user. For example, if I wanted to bind a command executor to the command
     * "help", I would put "help" in the cmdString argument. If I wanted to bind
     * another command executor to "help something", then I could type that in,
     * and the system would be able to distinguish between if the user wanted
     * the general help, or the help for 'something'. Maybe 'something' goes
     * under more than one name. Then you can put 'help {something|stuff}', and
     * it would point both 'help something' and 'help stuff' to the same
     * command. Maybe you're one of those people who likes to have the page
     * numbers before the arguments. The command system supports wildcards, so
     * you could register 'help * {something|stuff}', and whatever the user put
     * in place of the asterisk will be added to the preArgs parameter that will
     * be explained later on.
     * @param cmd The command executor
     * @return A set of the first word in the commands that were registered. For
     * for instance, if you registered '{a|b|c|d} some * stuff' to a command,
     * then a set containing 'a', 'b', 'c', 'd' would be returned.
     */
     ...
     * @return A
     * {@link com.lagopusempire.playerlookups.zorascommandsystem.CommandPackage CommandPackage}
     * containing various info about the command, including the executor itself,
     * ready to be run.
     */
     ...
     *
     * @param known The known correct sequence of arguments
     ...
     *
     * @param versionList Each version of a command is represented as a list of
     * strings. This is a set of all of the versions that it found.
     * @param workingVersion The method needs to be supplied an empty arraylist
     * to start building and expanding off of as it finds new versions to add to
     * the versionList
     * @param index The index to start searching at. You will probably want to
     * set this to 0.
     * @param cmdStringParts The array of strings that is being searched for the
     * various valid command possibilities (versions)
     */
     ...
     *
     * @param variant The string to parse
